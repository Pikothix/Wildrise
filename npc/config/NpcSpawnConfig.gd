...
@export var npc_definitions: Array[Dictionary] = [
	{
		...
		"scene": preload("res://npc/entity/lizard/lizard.tscn"),
	...
	},
	{
		...
		"scene": preload("res://npc/entity/squirrel/squirrel.tscn"),
		"allowed_biomes": ["plains", "jungle"],
	...
	},
	{
		"id": "cobra",
		"display_name": "cobra",
		"scene": preload("res://npc/entity/cobra/cobra.tscn"),
	...
	},
	{
		"id": "crab",
		"display_name": "crab",
		"scene": preload("res://npc/entity//crab/crab.tscn"),
